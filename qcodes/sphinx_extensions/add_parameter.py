...
original_add_directive_header = autodoc.AttributeDocumenter.add_directive_header
...
def add_parameter_spec_to_docstring(app, what, name, obj, options, lines):
    ...
    if "attribute" in what and ("Agilent_34400A.resolution" in name):
        print(app)
        print(what)
        print(name)
        print(obj)
        ...
        print("is param", isinstance(obj, _BaseParameter))
...
def setup(app):
    ...
    autodoc.AttributeDocumenter.add_directive_header = add_directive_header
