...
from qcodes import VisaInstrument, MultiParameter, ManualParameter
...
class MercuryiPSVisa(VisaInstrument):
    """
    ...
    .. todo::
        ...
        To be used with a raw TCP/IP connection TCPIP1::ipadress::7020::SOCKET
    """
    # def __init__(self, name, axes=None, **kwargs):
    #     super().__init__(name, terminator='\n', **kwargs)
    def __init__(self, name, address=None, axes=None, **kwargs):
