...
#
#
def one(curr: pg8000.Cursor, column: str) -> Any:
...
def one_column(curr: pg8000.Cursor, column: str) -> List[Any]:
    """
...
def many(curr: pg8000.Cursor, *columns: str) -> List[Any]:
...
def many_many(curr: pg8000.Cursor, *columns: str) -> List[List[Any]]:
...
def connect(name: str, debug: bool = False) -> pg8000.Connection:
...
def transaction(conn: pg8000.Connection,
                sql: str, *args: Any) -> pg8000.Cursor:
...
def atomicTransaction(conn: pg8000.Connection,
                      sql: str, *args: Any) -> pg8000.Cursor:
...
@contextmanager
def atomic(conn: pg8000.Connection):
    """
...
def init_db(conn: pg8000.Connection)->None:
    with atomic(conn):
...
def insert_column(conn: pg8000.Connection, table: str, name: str,
...
def select_one_where(conn: pg8000.Connection, table: str, column: str,
...
def select_many_where(conn: pg8000.Connection, table: str, *columns: str,
                      where_column: str, where_value: Any) -> Any:
...
def update_where(conn: pg8000.Connection, table: str,
...
def insert_values(conn: pg8000.Connection,
                  formatted_name: str,
                  columns: List[str],
                  values: VALUES,
                  ) -> int:
...
def insert_many_values(conn: pg8000.Connection,
                       formatted_name: str,
                       columns: List[str],
                       values: List[VALUES],
                       ) -> int:
...
def modify_values(conn: pg8000.Connection,
                  formatted_name: str,
                  index: int,
                  columns: List[str],
                  values: VALUES,
...
def modify_many_values(conn: pg8000.Connection,
                       formatted_name: str,
                       start_index: int,
                       columns: List[str],
...
def length(conn: pg8000.Connection,
           formatted_name: str
           ) -> int:
    """
...
def get_data(conn: pg8000.Connection,
             table_name: str,
             columns: List[str],
             start: int = None,
             end: int = None,
...
def get_values(conn: pg8000.Connection,
               table_name: str,
...
def get_setpoints(conn: pg8000.Connection,
                  table_name: str,
...
def get_layout(conn: pg8000.Connection,
...
def get_dependents(conn: pg8000.Connection,
                   run_id: int) -> List[int]:
    """
...
def get_dependencies(conn: pg8000.Connection,
...
def new_experiment(conn: pg8000.Connection,
                   name: str,
                   sample_name: str,
...
def mark_run(conn: pg8000.Connection, run_id: int, complete: bool):
    """ Mark run complete
...
def completed(conn: pg8000.Connection, run_id)->bool:
...
def finish_experiment(conn: pg8000.Connection, exp_id: int):
    """ Finish experiment
...
def get_run_counter(conn: pg8000.Connection, exp_id: int) -> int:
...
def get_experiments(conn: pg8000.Connection): # -> List[pg8000.Row]:
...
def get_last_experiment(conn: pg8000.Connection) -> int:
    """
...
def get_runs(conn: pg8000.Connection,
             exp_id: Optional[int] = None): #->List[pg8000.Row]:
    """ Get a list of runs.
...
def get_last_run(conn: pg8000.Connection, exp_id: int) -> str:
    query = """
...
def data_sets(conn: pg8000.Connection): # -> List[pg8000.Row]:
...
def _insert_run(conn: pg8000.Connection, exp_id: int, name: str,
...
def _update_experiment_run_counter(conn: pg8000.Connection, exp_id: int,
...
def get_parameters(conn: pg8000.Connection,
...
def get_paramspec(conn: pg8000.Connection,
                  run_id: int,
...
def add_parameter(conn: pg8000.Connection,
                  formatted_name: str,
                  *parameter: ParamSpec):
...
def _add_parameters_to_layout_and_deps(conn: pg8000.Connection,
                                       formatted_name: str,
                                       *parameter: ParamSpec) -> pg8000.Cursor:
    # get the run_id
    sql = f"""
...
def _create_run_table(conn: pg8000.Connection,
                      formatted_name: str,
                      parameters: Optional[List[ParamSpec]] = None,
...
def create_run(conn: pg8000.Connection, exp_id: int, name: str,
...
def get_metadata(conn: pg8000.Connection, tag: str, table_name: str):
...
def insert_meta_data(conn: pg8000.Connection, row_id: int, table_name: str,
...
def update_meta_data(conn: pg8000.Connection, row_id: int, table_name: str,
                     metadata: Dict[str, Any]) -> None:
    """
...
def add_meta_data(conn: pg8000.Connection,
                  row_id: int,
...
def get_user_version(conn: pg8000.Connection) -> int:
...
def set_user_version(conn: pg8000.Connection, version: int) -> None:
